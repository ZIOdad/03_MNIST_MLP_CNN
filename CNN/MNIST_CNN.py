...
"""
check_point = ModelCheckpoint(filepath='keras_mnist_model_CNN.h5', monitor='val_loss', save_best_only=True, verbose=1)
...
loaded_model = load_model('keras_mnist_model_CNN.h5')
